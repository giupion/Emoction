    ...
    public function store(Request $request)
    {
        try {
            ...
            $validatedData = $request->validate([
                ...
                'emozioni.*.intensita' => 'required|integer|between:1,10',
            ]);
            ...
            // Per ogni emozione inviata, crea una nuova istanza di Emotion
            foreach ($validatedData['emozioni'] as $emozione) {
                $emotion = new Emotion();
                $emotion->nome = $emozione['nome'];
                $emotion->intensita = $emozione['intensita'];
